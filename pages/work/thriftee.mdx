...
## Tech Stack
For the prototype, we used Next.js as the frontend framework, along the React Bootstrap as the styling library. We also used Zustand as the state management library to manage account info and shopping cart items.

As for the backend, we used Firebase to save all product information.
